...
\choice \chemfig{>[:330]-[:30]<:[:90]-[:30]-[:330](<[:110])>[:270](-[:210](-[:270]%
-[:210]-[:150](<[:210,,,2]HO)-[:90])(<:[:330])-[:150])-[:330](<[:270,,,1]OH%
)-[:30]>:[:90]-[:42](-[:114](<:[:60]O-[:120](-[:60])=[:180]O)-[:186]-[:258]%
(-[:210])(<:[:124])-[:330])=[:348](-[:48](-[:348,,,1]OH)=[:108]O)-[:288]%
-[:348]-[:288]=[:348](-[:288])-[:48]}

\choice \chemfig{-[:270](-[:210])(-[:150])-[:330]-[:30]\mcfabove{N}{H}-[:330]-[:30]%
=_[:90]-[:30](-[:90]N(-[:150])-[:30])=_[:330]-[:30]>[:330]-[:30]>[:330]%
-[:30](<:[:90]N(-[:30])-[:150])-[:330](=[:30]O)-[:270](-[:330](%
-[:30,,,1]NH_2)=[:270]O)=_[:210](-[:270,,,1]OH)-[:150](-[:90])(%
<:[:270,,,1]OH)-[:210](=[:270]O)-[:150](-[:90])=_[:210](-[:270,,,1]OH)%
-[:150](-[:90])=_[:210](-[:150])-[:270,,,1]OH}

\choice \chemfig{-[:90](-[:150])(-[:210])-[:30]\mcfabove{N}{H}-[:330]-[:30](=[:90]O%
)-[:330]\mcfbelow{N}{H}-[:30]=_[:90]-[:30](-[:90]N(-[:150])-[:30])=_[:330]%
-[:30]>[:330]-[:30]>[:330]-[:30](<:[:90]N(-[:30])-[:150])-[:330](=[:30]O)%
-[:270](-[:330](-[:30,,,1]NH_2)=[:270]O)=_[:210](-[:270,,,1]OH)-[:150](%
-[:90])(<:[:270,,,1]OH)-[:210](=[:270]O)-[:150](-[:90])=_[:210](%
-[:270,,,1]OH)-[:150](-[:90])=_[:210](-[:150])-[:270,,,1]OH}

\choice \chemfig{-[:315]-[:255]O-[:195]N=[:255](-[:195]=^[:141]N-[:213]S-[:285](%
-[:231]\mcfbelow{N}{H}-[:171]P(-[:231,,,2]HO)(-[:171,,,2]HO)=[:111]O)%
=^[:357]N-[:69])-[:315](=[:255]O)-[:15]\mcfabove{N}{H}>[:315]--[:270]N(%
-[:180](=[:225]O)-[:90])-[:330](-[:270](-[:330]\mcfright{O}{^{\mcfminus}})%
=[:210]O)=^[:30](-[:90]-[:150]S>[:210])-[:330]S-[:30]=^[:336]N-[:48](%
=^[:120]-[:192]S-[:264])-[:354]=^[:294]-[:354]=^[:54,,,2]^{\mcfplus}N(%
-[:354,,2])-[:114,,2]=^[:174](-[:234])}


\choice \chemfig{-[:150]-[:90](-[:30]\mcfabove{N}{H}-[:330])-[:150](=[:90]O)-[:210]%
=^[:150]-[:210]=^[:270](-[:330]=^[:30]-[:90])-[:198]O-[:126]-[:54]O(-[:342]%
)}
