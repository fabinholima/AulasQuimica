...
#+LATEX_HEADER: \DeclareExerciseCollection{radio1}
...
#+begin_exercise
Após algumas desintegrações sucessivas, o \isotope{232,Th}, muito encontrado na orla marítima de Guarapari (ES), se transforma no 82Pb208. Qual o número de partículas $\upalpha$ e $\upbeta$ emitidas nessa tranformação ?
#+end_exercise 
