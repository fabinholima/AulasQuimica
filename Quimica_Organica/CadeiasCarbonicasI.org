...
#+LATEX_HEADER: \DeclareExerciseCollection{Cadeias-Open}
...
\begin{center}
\chemname{\chemfig{H_3C-S-CH_2-CH_2-CH([:-90]-NH_2)-C([:90]=O)OH}}{Metionina}
\\
\vspace{.5cm}
\chemname{\chemfig{HS-CH_2-CH([:-90]-NH_2)-C([:90]=O)OH}}{Cisteína}
\end{center}
#+end_export
#+begin_choice
