...
\begin{tblr}{colspec={lc},rowspec={|[2pt,purple5]Q|[2pt,purple5]Q|[purple5]Q|[purple5]Q|[purple5]Q|[purple5]Q|[purple5]Q|[3pt,purple5]}}
\SetCell[c=2]{c}{\bfseries Monomêros}\\
{\bfseries Substâncias} & {\bfseries F\'ormula}\\
{Cafeina \\ (café)} &  \chemfig[atom style={scale=.6}]{-[:42]N-[:96]=_[:24]N-[:312]=_[:240](-[:168]\phantom{N})-[:300](%
	=[:240]O)-N(-[:300])-[:60](=O)-[:120]N(-[:180])-[:60]}\\
{Nicotina \\ (cigarro)} &  \chemfig[atom style={scale==.6}]{-[:264]N-[:210]-[:282]-[:354]-[:66](-[:138]\phantom{N})<:[:12]%
	=^[:312]-[:12]N=^[:72]-[:132]=^[:192](-[:252])}\\
{Morfina \\ (inibidor de dor)} &  
\chemfig[cram width=3pt, atom style={scale=.5}]{HO-[:30,,2]-[:90]-[:30]-[:330](-[:270]=_[:210]-[:150])-[:30](%
	...
	-[:313.1,1.381])=_[:90](-[:150,,,2]HO)-[:30]=_[:330](-[:270])}\\
